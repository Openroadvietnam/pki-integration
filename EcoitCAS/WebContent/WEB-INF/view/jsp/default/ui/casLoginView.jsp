...
<script src="http://code.jquery.com/jquery-latest.min.js"></script>
	<script> 
        var attributes = {id:'caApplet',
        		code : 'com.ecoit.asia.EcoitApplet',  width:1, height:1} ; 
        var parameters = {jnlp_href: '/EcoitCAS/plugin/CAAppletSimple.jnlp'};
...
$( document ).ready(function() {
	...
	$('#login-token').click(function(){
		...
		$.ajax({
            type: "post",
            datatype: "json",
            data: {base64Encode: base64Certificate},
            url: "/EcoitCAS/ajax/challange.jsp", //this is my servlet
            success: function(msg){
				var status = msg['status'];
				if (status == 1){
					var username = msg['username'];
					var challange = msg['challange'];
					var response = document.caApplet.response(challange);
					$('#username').val(username);
					$('#password').val(response);
					document.fm1.submit.click();
				} else {
			...
			<form:form method="post" id="fm1" name='fm1' cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">
                ...
                <!-- <spring:message code="screen.welcome.welcome" /> -->
                    ...
                    <div class="row btn-row">
                        ...
                        <input class="btn-submit" id='login-token' accesskey="l" value="Token Login" tabindex="5" type="button" />
